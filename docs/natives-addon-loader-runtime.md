...
2. `require(candidate)`.
3. Require the expected package-version sentinel function; addons predating sentinels may bridge on a compatible ABI signature.
